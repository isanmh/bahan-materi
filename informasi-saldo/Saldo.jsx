...
const Saldo = () => {
  ...
  const informasiSaldo = () => {
    ...
    const headers = {
      ...
      Authorization:
        "Bearer " +
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiJlNDBjNjA2MS1lNGJiLTRiYWYtOGE4NC1kMWQzMGVlZjNiMWQiLCJjbGllbnRJZCI6IjVlMzQ5ZTIwNjQxZDQzZGI5MDlkNmUyMDE5Yzk5MzExIiwibmJmIjoxNzI3ODc0ODgwLCJleHAiOjE3Mjc4NzU3ODAsImlhdCI6MTcyNzg3NDg4MH0.7_C-YXL_1Zqmp3-58AEPSyFYE86WCYFqKUmxuTPyjBk",
      "X-SIGNATURE":
        "+BeTedHCh8+BUVNxsyDr0xl6VwgzGfqkEINMJB+dgY5lwHXnSCZ7agT0KrT5fhNZgjt9fwq30Bbi4ltNwcSNEQ==",
    };
